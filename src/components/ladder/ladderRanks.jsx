...
export const LadderRanks = () => {
  return (
    <div className='ladderRanks'>
      <div className='ladderSingleRank'>1.000.000 KN</div>
      <div className='ladderSingleRank'>500.000 KN</div>
      ...
      <div className='ladderSingleRank'>100 KN</div>
    </div>
  );
};
